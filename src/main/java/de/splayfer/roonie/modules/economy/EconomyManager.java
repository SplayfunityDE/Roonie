...
public class EconomyManager implements SlashCommandManager {
    ...
    public void addMoneyToUser(Member member, int amount) {
        insertUser(member);
        mongoDB.updateLine("money", new Document("guildMember", member.getIdLong()), "amount", getMoney(member) + amount);
    }

    public void removeMoneyFromUser(Member member, int amount) {
        insertUser(member);
    ...
    public int getMoney(Member member) {
    ...
    public void setMoney(Member member, int amount) {
        insertUser(member);
        mongoDB.updateLine("money", new Document("guildMember", member.getIdLong()), "amount", amount);
    }

    public Map<Integer, Long> top(int top) {
