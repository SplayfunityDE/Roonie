...
public class RemoveTemplateCommand extends ListenerAdapter {
                ...
                if (event.getMember().getPermissions().contains(Permission.ADMINISTRATOR)) {
                    ...
                    if (args.length == 3) {
                        ...
                        if (LibraryManager.existsTemplate(link)) {
                            ...
                            succes.setTitle(":open_file_folder: Server Template erfolgreich entfernt!");
                            succes.setDescription("Die angegeben Server Template wurde erfolgreich aus der Bibliothek entfernt!");
                            succes.addField("Details zu dieser Aktion", ":link: Template: `" + link + "`\n" +
                            ...
                            embedBuilder.setTitle(":exclamation: **Diese Template wurde noch nicht hinzugefügt!**");
                        ...
                        EmbedBuilder embedBuilder = new EmbedBuilder();
                        embedBuilder.setTitle(":exclamation: **Bitte nutze `/template remove <Link>`!**");
                        embedBuilder.setColor(0xc01c34);
